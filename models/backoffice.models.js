...
BackOffice.getWineById = (id, result) => {
    if (id) {
        ...
        const sql = `        
            ...
            SELECT vineyards_wines.vineyardId, vineyards.name FROM vineyards_wines LEFT JOIN vineyards ON vineyards_wines.vineyardId = vineyards.id WHERE wines_strains.wineId = ? GROUP BY vineyards_wines.vineyardId;
        `;
